...
##### cmake module
For Example:cmake/FindOpencv.cmake
	you can set your opencv path.
#### 2.3 Build
		cd dso
		mkdir build
		cd build
		...
		make -j4
#### 2.4 Run
	1.use run.sh dataset mode,change file path
	2.use run_ros.sh ros mode,change image:=topic_name,config set you
